...
- all handoff and operating docs for agents: English
...
| --- | --- | --- |
| `regulated-final-bundle/01-control-packet.md` | Hard strategy lock | locked |
| `regulated-final-bundle/02-approved-regulated-source-packet.md` | Compact upload packet | locked |
| `regulated-final-bundle/03-run-paths.md` | Execution map | approved |
| `regulated-final-bundle/04-acceptance-gate.md` | Universal QA gate | locked |
| `regulated-final-bundle/05-regulated-sales-kit-definition-of-done.md` | Done rubric | locked |
| `source-of-truth/04-regulated-buyer-model.md` | Buyer logic | canonical |
| `source-of-truth/05-message-house.md` | Message policy | canonical |
| `source-of-truth/06-claims-register.md` | Claim safety | canonical |

### Approved Outputs

| Type | Path | Status |
| --- | --- | --- |
| Buyer-facing asset | `buyer-facing/regulated/01-executive-deck-regulated.md` | approved |
| Buyer-facing asset | `buyer-facing/regulated/02-why-us-regulated.md` | approved |
| Buyer-facing asset | `buyer-facing/regulated/03-one-job-unified-line.md` | approved |
| Buyer-facing asset | `buyer-facing/regulated/04-edge-cases-exceptions.md` | approved |
| Buyer-facing asset | `buyer-facing/regulated/05-evidence-pack-audit-ready.md` | approved |
| Buyer-facing asset | `buyer-facing/regulated/06-technical-presale-deck.md` | approved |

### Working Drafts / Experimental / Deprecated

| Item | Use status | Note |
| --- | --- | --- |
| `source-of-truth/07-regulated-sop-distillate.md` | use with caution | upstream reinforcement only |
| `dominanta-sales/07-gorobina-account-note.md` | use with caution | account-specific branch only |
| `REGULATED / Technical Deck / Visual / Empty Draft` | do not use | accidental empty draft |

## Notebook Inventory

| Notebook name | Notebook id | Notebook URL | Purpose | Source count | Status | Use status |
| --- | --- | --- | --- | ---: | --- | --- |
| `REGULATED / Executive Deck / Text + Visual` | `8493747d-88a6-42d8-8aa4-202243245726` | [open](https://notebooklm.google.com/notebook/8493747d-88a6-42d8-8aa4-202243245726) | Executive text and visual generation | 4 | active | use |
| `REGULATED / Why Us / Text + Visual` | `e4f3eece-586c-49e0-897a-544cebe56761` | [open](https://notebooklm.google.com/notebook/e4f3eece-586c-49e0-897a-544cebe56761) | Why Us text and visual generation | 4 | active | use |
| `REGULATED / One Job / Text` | `32eafde7-dc70-4663-9f2b-c744e59769ab` | [open](https://notebooklm.google.com/notebook/32eafde7-dc70-4663-9f2b-c744e59769ab) | One Job text generation | 4 | active | use |
| `REGULATED / One Job / Visual` | `9be5e89c-132c-43ed-9024-1046f6177c1d` | [open](https://notebooklm.google.com/notebook/9be5e89c-132c-43ed-9024-1046f6177c1d) | One Job visual generation | 4 | active | use |
| `REGULATED / Edge Cases / Text` | `25b37bc9-6f79-4da1-a153-6fbe6d01c463` | [open](https://notebooklm.google.com/notebook/25b37bc9-6f79-4da1-a153-6fbe6d01c463) | Edge Cases text generation | 4 | active | use |
| `REGULATED / Edge Cases / Visual` | `d7f0e00a-81ce-481b-a6aa-b5bd4ab19852` | [open](https://notebooklm.google.com/notebook/d7f0e00a-81ce-481b-a6aa-b5bd4ab19852) | Edge Cases visual generation | 4 | active | use with caution |
| `REGULATED / Evidence Pack / Text` | `df81338e-e697-454c-9b1e-013c38ac13fd` | [open](https://notebooklm.google.com/notebook/df81338e-e697-454c-9b1e-013c38ac13fd) | Evidence Pack text generation | 4 | active | use |
| `REGULATED / Evidence Pack / Visual` | `f3973629-1ac6-4a98-a4e4-3edcc1b0a6e8` | [open](https://notebooklm.google.com/notebook/f3973629-1ac6-4a98-a4e4-3edcc1b0a6e8) | Evidence Pack visual generation | 4 | active | use with caution |
| `REGULATED / Technical Deck / Text` | `7b495a98-d837-4144-b9f7-8c1a15bfc1bc` | [open](https://notebooklm.google.com/notebook/7b495a98-d837-4144-b9f7-8c1a15bfc1bc) | Technical Deck text generation | 4 | active | use |
| `REGULATED / Technical Deck / Visual` | `cf45709c-fa6b-4c40-9def-25b0456a6776` | [open](https://notebooklm.google.com/notebook/cf45709c-fa6b-4c40-9def-25b0456a6776) | Technical Deck visual generation | 4 | active | use with caution |
| `REGULATED / Technical Deck / Visual / Empty Draft` | `27a60eee-9f31-4bca-ae23-c4ddb19f755a` | [open](https://notebooklm.google.com/notebook/27a60eee-9f31-4bca-ae23-c4ddb19f755a) | Unused draft notebook | 0 | inactive | do not use |
...
| Asset | Earlier output | Replaced by / current | Current status |
| --- | --- | --- | --- |
| Executive Deck | baseline + intermediate reruns | `2026-03-22-executive-deck-notebooklm-rerun-v2-clean.md` | current canonical text |
| Why Us | first run | `2026-03-22-why-us-notebooklm-clean.md` | current canonical text |
| One Job | `2026-03-22-one-job-notebooklm-revise.md` | `2026-03-22-one-job-notebooklm-clean.md` | current canonical text |
| Edge Cases | `2026-03-22-edge-cases-notebooklm-revise.md` | `2026-03-22-edge-cases-notebooklm-clean.md` | current canonical text |
| Evidence Pack | `2026-03-22-evidence-pack-notebooklm-revise.md` | `2026-03-22-evidence-pack-notebooklm-clean.md` | current canonical text |
| Technical Deck | `2026-03-22-technical-deck-notebooklm-revise.md` | `2026-03-22-technical-deck-notebooklm-clean.md` | current canonical text |
