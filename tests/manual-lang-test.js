...
if (langToggle) {
	...
	const titleBefore = document.querySelector(
		'[data-i18n="hero.title"]',
	)?.textContent;
	langToggle.click();
	const afterClickLang = html.lang;
	const titleAfter = document.querySelector(
		'[data-i18n="hero.title"]',
	)?.textContent;
	...
	console.log(
		"Language toggle is",
		afterClickLang !== initialLang ? "WORKING ✓" : "BROKEN ✗",
	);
	console.log(
		"Translations are",
		titleBefore !== titleAfter ? "WORKING ✓" : "BROKEN ✗",
	);
} else {
